...
<?php 						echo __("An error has occured"); ?>
						...
						<p class="error-box">
							...
							<a href="javascript:top.history.back();"><?php echo __("Go back"); ?></a> or <a href="<?php echo $net2ftp_globals["application_rootdir_url"]; ?>/index.php/net2ftp?state=clearcookies"><?php echo __("Go to the login page"); ?></a></p><br />
						</p>
						<div id="error_hidden">
...
<?php
require_once($net2ftp_globals["application_skinsdir"] . "/"."shinra" . "/footer.template.php");
